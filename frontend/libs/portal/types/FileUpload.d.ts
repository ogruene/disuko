...
declare const _default: import('vue').DefineComponent<
  {
    ...
    addIndex: {
      type: Array<BooleanConstructor | NumberConstructor>;
    };
    directory: {
      type: BooleanConstructor;
    };
  ...
  },
  {
    ...
    add(
      _files: VueUploadItem | Blob | Array<VueUploadItem | Blob>,
      index?: number | boolean | undefined,
    ): VueUploadItem | VueUploadItem[] | undefined;
    ...
    uploadXhr(
      xhr: XMLHttpRequest,
      ufile: VueUploadItem | undefined | false,
      body: FormData | Blob,
    ): Promise<VueUploadItem>;
    uploadHtml4(ufile: VueUploadItem | undefined | false): Promise<VueUploadItem>;
    watchActive(active: boolean): void;
    watchDrop(
      newDrop: boolean | string | HTMLElement | null,
      oldDrop?: boolean | string | HTMLElement | undefined,
    ): void;
  ...
  import('vue').ComponentOptionsMixin,
  Array<'update:modelValue' | 'input-filter' | 'input-file'>,
  'update:modelValue' | 'input-filter' | 'input-file',
