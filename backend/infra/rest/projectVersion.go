...
import (
	...
	overallreview2 "mercedes-benz.ghe.com/foss/disuko/domain/overallreview"

	"golang.org/x/text/language"

	"mercedes-benz.ghe.com/foss/disuko/helper/csvutil"
	"mercedes-benz.ghe.com/foss/disuko/helper/rest"
	...
	detailsService "mercedes-benz.ghe.com/foss/disuko/infra/service/componentDetails"
	"mercedes-benz.ghe.com/foss/disuko/infra/service/licenseremarks"
	...
	reviewRemarksService "mercedes-benz.ghe.com/foss/disuko/infra/service/reviewremarks"
	...
	sbomlockRetained "mercedes-benz.ghe.com/foss/disuko/infra/service/check-sbom-retained"
...
func (projectHandler *ProjectHandler) ProjectVersionSPDXMetaByIDExtern(w http.ResponseWriter, r *http.Request) {
	...
	responseData := project.SPDXMetaPublicResponse{
		...
		Status:   true,
		IsRetain: spdxFile.IsToRetain || IsSpdxRetained(spdxFile, currentProject, version),
	}
	render.JSON(w, r, responseData)
}
