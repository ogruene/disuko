...
//go:generate oapi-codegen --config=../../resources/connectorapis/userrole-config.yaml ../../resources/connectorapis/userrole.yaml
...
func (c *Connector) UserActive(rs *logy.RequestSession, userID string) bool {
	res, err := c.client.GetUsersUseridActiveWithResponse(context.Background(), userID)
	if err != nil {
